...
subtitle: "Cam Race"
author: "Statistics Development Team, DfE"
date: "2021/07/13" #(updated: `r format(Sys.Date(), '%Y/%m/%d')`)"
output:
...
It's a classic government jargony acronym that I can't stand
...
It boils down to doing our jobs in the best way we can

Heavily leans on ideas and best practice in software engineering

Forms a best practice framework for any data analysis we do
